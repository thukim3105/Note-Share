                ...
                <div className="w-full max-w-lg rounded-3xl border border-[#e8e6dc] bg-white p-8 shadow-sm">
                    <div className="space-y-4">
                        ...
                        <LoginForm
                            ...
                            loading={loading}
                        />
                        {statusMessage ? <Text className="text-sm text-[#4d4c48]">{statusMessage}</Text> : null}
                    </div>
                </div>
            </div>
        )
                                    ...
                                    <DropDown
                                        ...
                                        items={[
                                            ...
                                            },
                                            {
                                                ...
                                                onClick: () => setConfirmModal({ open: true, action: row.is_deleted ? 'restore' : 'delete', user: row }),
                                            },
                                        ]}
                                    />
                                </td>,
